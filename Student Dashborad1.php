        ...
        <tbody>
          ...
          <?php
           require_once('./Config.php');
                ...
                // }
                $id = $_SESSION['id'];
                $query= "SELECT DISTINCT studentcourses.CID,studentcourses.coursename,studentcourses.semester,studentcourses.campus FROM studentcourses INNER JOIN students ON studentcourses.SID='$id'";
               ...
               while( $record = $result->fetch_array()){
                ...
                // var_dump($record['campus']);
                //  echo $k;
                // echo $record['coursename'];
                // ECHO "<br>";
                // $k++;
                // echo'<li>$record["CID"].' '.$record['coursename']</li>';
               //echo"<li>$record['CID']</li>";
